...
const Product =  (props) => {
    ...
    const desc = props.shopDetails ? `Shop for ${props.productDetails.productTitle} near you from ${props.shopDetails.shopName} located at ${props.shopDetails.shopAddress}. Check for best price Now!` : "Find Prooducts at best prices in a shop near you";
